...
{
    const char* pszTimestamp = "CIRCLE LLC 25/Jan/2019 Amole Coin Was Created";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1548428154, 1668139, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xd225ab35bb03bfc6ff07ef63f39d5d33d22b40adc9f7c52b60d0a8a9b44c2e52"));
        assert(genesis.hashMerkleRoot == uint256S("0xe1763c196fc5686556ec57ca4317480045888f173d2d3ff2e8fb22961c6d5910"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.emplace_back("dnsseed.amoleco.in", true);
        //vSeeds.emplace_back("seed-a.amolecoin.loshan.co.uk");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.amolecointools.com");
        //vSeeds.emplace_back("dnsseed.amolecoinpool.org");
        ...
        checkpointData = {
            {
                {  0, uint256S("0xd225ab35bb03bfc6ff07ef63f39d5d33d22b40adc9f7c52b60d0a8a9b44c2e52")},
/*                {  4032, uint256S("0x9ce90e427198fc0ef05e5905ce3503725b80e26afd35a987965fd7e3d9cf0846")},
        ...
        chainTxData = ChainTxData{
            ...
            1548428154, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.amolecointools.com");
        vSeeds.emplace_back("seed-b.amolecoin.loshan.co.uk");
