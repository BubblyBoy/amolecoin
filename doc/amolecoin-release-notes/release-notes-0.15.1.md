Amolecoin Core version *0.15.1* is now available from:

  <https://download.amolecoin.org/amolecoin-0.15.1/>
...
A number of changes to the way Amolecoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 nakfas per kB (0.00001 AMC). This is to prepare for dropping the minimum transaction fee to 0.1 nakfas per kB (0.0001 AMC) in the next release.
