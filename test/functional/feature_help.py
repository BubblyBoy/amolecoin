...
"""Verify that starting amolecoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start amolecoin with -h for help text")
        ...
        self.log.info("Start amolecoin with -version for version information")
