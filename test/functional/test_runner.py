...
def run_tests(test_list, src_dir, build_dir, exeext, tmpdir, jobs=1, enable_coverage=False, args=[], combined_logs_len=0):
    ...
    if "LITECOIND" not in os.environ:
        os.environ["LITECOIND"] = build_dir + '/src/amolecoind' + exeext
        os.environ["LITECOINCLI"] = build_dir + '/src/amolecoin-cli' + exeext
...
class RPCCoverage():
    ...
    commands per `amolecoin-cli help` (`rpc_interface.txt`).
